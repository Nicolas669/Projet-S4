...
def cree_map_avec_chemin(liste,point_arr):
    '''nom_map est le nom de l'image avec les boites et le graphe deja dessiné,
     la liste est le chemin renvoyé par l'algo des voyageurs'''
    pygame.init()
    ...
    for i in range(len(liste)-1):
        pygame.draw.line(fenetre, (0, 0, 255),
                         [round(liste[i].getAbscisse()), round(liste[i].getOrdonnee())],
